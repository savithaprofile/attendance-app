...
import { FiUser, FiMail, FiLock, FiBriefcase, FiHome, FiCalendar } from 'react-icons/fi';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-10 border border-gray-200 animate-fade-in">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 mt-2">Fill in the details to create a user with a weekly schedule</p>
        </div>

        {error && <div className="mb-6 p-3 bg-red-100 text-red-800 border border-red-300 rounded-md text-sm">{error}</div>}
        {success && <div className="mb-6 p-3 bg-green-100 text-green-800 border border-green-300 rounded-md text-sm">{success}</div>}
